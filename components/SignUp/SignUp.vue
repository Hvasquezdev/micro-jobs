...
.sign-up-form .custom-checkbox .icon-checked {
  position: absolute;
  transform: scale(0.8);
  visibility: hidden;
}
.sign-up-form input[type='checkbox']:checked + .custom-checkbox .icon-checked {
  visibility: visible;
}
.sign-up-form input[type='checkbox']:checked + .custom-checkbox {
